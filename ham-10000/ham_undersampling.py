from undersample_json import us_json_multi
...
us_json_multi(fold1, output_dir, 'fold1', 7)
us_json_multi(fold2, output_dir, 'fold2', 7)
us_json_multi(fold3, output_dir, 'fold3', 7)
us_json_multi(fold4, output_dir, 'fold4', 7)
us_json_multi(fold5, output_dir, 'fold5', 7)
